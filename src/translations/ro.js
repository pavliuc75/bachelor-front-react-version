...
export default {
  ...
  sorryWeCannotFindThePage:
    "Ne pare rău, nu putem găsi pagina pe care o căutați. Fie a fost mutată, fie ștearsă, fie nu mai există.",
  ...
  doNotIncludeBusinessEntityTypeInformationEtc:
    "Nu includeți informații despre tipul de entitate comercială. Acest lucru va fi necesar în pasul următor.",
  ...
  pleaseBeAwareThatIfYouNeedToReUploadOneFileYouWillHaveTo:
    "Vă rugăm să rețineți că, dacă trebuie să reîncărcați un fișier, va trebui să reîncărcați și pe celălalt, altfel niciunul dintre fișiere nu va fi actualizat.",
  createBusinessPageRequestHasBeenUpdated:
    "Solicitarea de creare a paginii de afaceri a fost actualizată. Pagina se va reîncărca în câteva secunde.",
  ...
  ifYouCannotTheCategoryThatFitsTheProductYouCan:
    "Dacă nu găsiți categoria care se potrivește produsului, puteți solicita adăugarea unei noi categorii în listă. Acest lucru se poate face din secțiunea ALTE din bara laterală.",
  other: "Altele",
  requestANewCategory: "Solicitați o nouă categorie de produse",
  requestANewCategoryDescription:
    "După ce trimiteți cererea, administratorul o va revizui și, dacă este aprobată, va fi adăugată în lista de categorii.",
